import CellBiologyCytoskeletonActinLemmaCanonicalLaneLean.FinalTheorem
...
Cell Biology Cytoskeleton Actin Lemma endgame pilot. The pilot closes over its
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedCellBiologyCytoskeletonActinLemmaClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_cell_biology_cytoskeleton_actin_lemma_endgame A
